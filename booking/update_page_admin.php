    ...
    <div class=container>
        <form method="post" action="update_booking.php">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="id" class="form-control" id="destination" placeholder="change destination" value="<?= $res['id_reservation'] ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="date">Price Trip</label>
                <input type="number" class="form-control" name="date" value="<?= $res['price_trip'] ?>" class="form-control" id="date" placeholder="change trip date">
            </div>
            <div class="form-group">
