...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form id="form1" action="save_booking.php" method="POST" enctype="multipart/form-data">
                ...
                <button type="button" class="btn btn-primary" onclick="submitForm1()">Next</button>
            </form>
            <form id="form2" action="save_booking.php" method="POST" enctype="multipart/form-data" style="display:none;">
                <div class="form-group">
