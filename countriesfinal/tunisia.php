    ...
    #hero {
        width: 100%;
        height: 100vh;
        background: linear-gradient(rgba(55, 142, 181, 0.5), rgba(55, 142, 181, 0.2)), url("img/Balih9.jpg") top center;
    ...
    .cta {
        background: linear-gradient(rgba(238, 241, 243, 0.8), rgba(84, 88, 90, 0.8)), url("img/" ) fixed center center;
        background-size: cover;
        padding: 60px 0;
    }
</style>
