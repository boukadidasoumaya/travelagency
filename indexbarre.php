...
<head>
  ...
  <!-- Favicons -->
  <link href="../travelagency/countries/assets/img/favicon.png" rel="icon" />
  <link href="../travelagency/countries/assets/img/apple-touch-icon.png" rel="apple-touch-icon" />
  <!-- <link type="text/css" rel="stylesheet" href="../travelagency/fragments/barre.css">-->
  ...
  <link href="../travelagency/countries/assets/vendor/aos/aos.css" rel="stylesheet" />
  <link href="../travelagency/countries/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
  <link href="../travelagency/countries/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet" />
  <link href="../travelagency/countries/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet" />
  <link href="../travelagency/countries/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet" />
  <link href="../travelagency/countries/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet" />

  <!-- Template Main CSS File -->
  <link href="../travelagency/countries/assets/css/style.css" rel="stylesheet" />
...
<body>
  <!-- ======= Header ======= -->
  <?php include_once '../travelagency/fragments/barre/barre.php' ?>
  <!-- End Header -->
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up">
              <div class="pic">
                <img src="img/Local guides/wayanS.jpg" class="img-fluid" alt="" />
              </div>
              <div class="member-info">
                <h4>Wayan S.</h4>
                <span>Despasar, Bali, Indonesia</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="pic">
                <img src="img/Local guides/NyomanGM.jpg" class="img-fluid" alt="" />
              </div>
              <div class="member-info">
                <h4>Nyoman G. M.</h4>
                <span>Despasar, Bali, Indonesia</span>
  ...
  <!-- Vendor JS Files -->
  <script src="../travelagency/countries/assets/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="../travelagency/countries/assets/vendor/aos/aos.js"></script>
  <script src="../travelagency/countries/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="../travelagency/countries/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="../travelagency/countries/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="../travelagency/countries/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="../travelagency/countries/assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="../travelagency/countries/assets/js/main.js"></script>
